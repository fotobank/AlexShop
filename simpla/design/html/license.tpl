...
<textarea style='width:420px; height:250px;'>Настоящее пользовательское соглашение (далее — Соглашение) является юридическим соглашением между пользователем CMS «AlexShop» (далее — Продуктом) и  Автором CMS.
